...
public class Task_013_Methods {
    ...
    public static void printCityPopulation(String city, double population){
        ...
        System.out.println("В то время как в самом густонаселенном городе " + Task_013_Methods.city + " население составляет " + Task_013_Methods.population + " млн человек.");
    }
}
